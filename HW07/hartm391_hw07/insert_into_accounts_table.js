...
con.connect(function(err) {
  ...
  var adminrow = {
    ...
    acc_password: sha1("secretadminpass") // replace with acc_password chosen by you OR retain the same value
  };
  ...
  con.query('INSERT tbl_accounts SET ?', adminrow, function(err, result) {
    if(err) {
      throw err;
    }
